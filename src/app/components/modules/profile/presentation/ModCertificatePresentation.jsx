 ...
 * @returns {JSX.Element} A multi-stage form for managing certificate information
 */
      ...
      {isLoading && (
        <div className="fixed inset-0 bg-black/20 flex items-center justify-center z-50 rounded-lg">
          <div className="bg-background p-4 rounded-md shadow-lg flex flex-col items-center gap-3">
            ...
            <p className="font-medium">Saving your certificate information...</p>
          </div>
        </div>
      )}
        ...
        <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-4">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Add skills or knowledge areas that this certification validates or covers.
                </p>
                <div className="flex gap-2">
                  <Input
                    value={skillInput}
          ...
          {currentStage === 4 && (
            <div className="space-y-6">
              <h3 className="text-lg font-semibold">Review Your Certificate Information</h3>
              ...
              <div className="border rounded-md p-4 bg-muted/20 space-y-4">
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-2">
                    ...
                    <div>
                      ...
                      <p className="font-medium">{watch("issuingOrganization")}</p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-2">
                    <div>
                      ...
                      <p className="font-medium">{`${watch("issueDate.month")} ${watch("issueDate.year")}`}</p>
                    </div>
                    <div>
                      ...
                      <p className="font-medium">
                        {neverExpires 
                          ? "This certificate does not expire" 
                          : `${watch("expirationDate.month")} ${watch("expirationDate.year")}`}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <h4 className="font-semibold text-sm text-muted-foreground">Skills & Knowledge</h4>
          ...
          {showSuccess && (
            <div className="mt-4 bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative">
              <span className="block sm:inline">Certificate information saved successfully!</span>
            </div>
          )}
        </form>
      </Form>
