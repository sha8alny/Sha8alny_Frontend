        ...
        <div>
            ...
            <div className="bg-[var(--background)] border border-gray-600 rounded-b-lg">
                <div className="bg-[var(--foreground)] p-5 m-5 rounded-lg">
                    ...
                    <button className="flex items-center gap-1 bg-[var(--secondary)] text-[var(--background)] rounded-full cursor-pointer mt-3 py-[6px] px-4" data-testid="Follow-button"><AddIcon/> Follow</button>
                </div>
            </div>
        </div>
