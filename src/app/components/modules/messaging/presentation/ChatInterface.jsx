...
// Sub-components
const ChatHeader = React.memo(({ onBack, otherParticipant, isOtherParticipantTyping, isOtherUserBlocked, onBlockUser, onUnblockUser }) => (
...
const MessageList = React.memo(({ messages, currentUser, otherParticipant }) => (
...
const ChatInput = React.memo(({ message, mediaFiles, fileInputRef, onSendMessage, onTyping, onKeyDown, onFileSelect, onRemoveFile }) => (
    <>
        {mediaFiles.length > 0 && (
...
export function ChatPresentation({
    ...
    const otherParticipant = useMemo(() => 
        selectedConversation.participants?.find(p => p.username !== currentUser),
        [selectedConversation.participants, currentUser]
    );
    
    const isOtherParticipantTyping = useMemo(() => 
        otherParticipant?.username ? 
            selectedConversation.typingStatus?.[otherParticipant.username] === true : false,
