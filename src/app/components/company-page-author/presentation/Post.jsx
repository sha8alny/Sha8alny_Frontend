...
function Post({username, followers, text, imageUrl, likes, liked, comments=[], onLike, onComment, logoPreview}){
    return(
        <div className="w-145 mt-2">
            {/*Post Container*/}
            <div className="mt-4 border border-[var(--secondary)] rounded-lg p-4">
                ...
                <div className="mt-2 p-2">
                    ...
                    {imageUrl && imageUrl.trim() !== "" && (
                        <img src={imageUrl} alt="Post" className="w-full h-full rounded-lg mt-2" />
                    )}
                </div>
