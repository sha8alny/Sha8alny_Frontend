...
function WritePost({text, setText,onChange, preview, triggerFileInput,fileInputRef,onSubmit, logoPreview}) {
  return (
    <div>
        <div className="w-145 mt-5 border border-[var(--secondary)] rounded-lg p-4">
            ...
            <div className="flex items-center gap-4 mt-4 justify-between">
                <div htmlFor="upload-file" className="relative group">
                    ...
                    <input id="upload-file" type="file" className="hidden" accept="image/png, image/jpg, image/jpeg" ref={fileInputRef} onChange={onChange}/>
                </div>
