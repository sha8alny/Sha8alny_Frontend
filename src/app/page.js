    ...
    <div className="w-screen h-screen overflow-auto">
      ...
      <div className="gap-4 px-4 md:px-16 pt-8 flex">
        <div className="hidden md:flex flex-1 rounded-lg flex-col gap-2 items-center">
          <LeftSidebar />
          <button className="w-full drop-shadow-lg h-14 bg-primary hover:bg-primary/90 cursor-pointer ease-in-out duration-500 text-background border border-[#111] rounded-full font-bold p-2">
            Post
          </button>
        </div>
